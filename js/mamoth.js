...
(function() {
  var animate, camera, ctmLoader, depthMaterial, depthRenderTarget, effectComposer, fragmentShader, initScene, initStats, onWindowResize, orbitControl, pars, planeGeo, planeMat, planeObj, postprocessing, ref, render, renderModeChange, renderPass, renderer, sandMat, scene, spotLight, ssaoPass, stats, translate, vertexShader;
