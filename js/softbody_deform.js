...
(function() {
  ...
  appStart = function() {
    var boxGeo, boxMat, boxObj, clock, distanceConstrains, f, fa, fb, fc, geometry, geometryTopo, gui, h, invRestMat, k, l, len1, len2, planeGeo, planeLeft, planeMat, planeObj, planeRight, planeSideGeo, ref1, ref2, render, restCm, restVolume, textureLoader, tmpVec, trans, updateDistanceConstrains, updatePlaneConstrains, v, wnv, x0;
    ...
    textureLoader.load("../textures/brick_diffuse.jpg", function(map) {
      ...
      boxMat.map = map;
      return boxMat.needsUpdate = true;
    });
...
//# sourceMappingURL=softbody_deform.js.map
