...
(function() {
  var Cloth, ClothParticle, TIMESTEP, TIMESTEP_SQ, axes, camera, cloth, clothFrameMaterial, clothGeo, clothMaterial, clothObj, gravity, gui, guiData, h, initScene, initStats, j, len, light, onWindowResize, p, pinballObj, pins, planeGeo, planeMat, planeObj, ref, ref1, ref2, render, renderer, scene, sphereGeo, sphereMat, stats, textureLoader, wind;
  ...
  if ((ref = document.getElementById("stats-output")) != null) {
    ref.appendChild(stats.domElement);
  }

  ref1 = initScene(), scene = ref1.scene, camera = ref1.camera, renderer = ref1.renderer;

  if ((ref2 = document.getElementById("webgl-output")) != null) {
    ref2.appendChild(renderer.domElement);
  }
  ...
  textureLoader.load("../textures/hardwood2_diffuse.jpg", function(map) {
    ...
    map.repeat.set(3, 3);
    planeMat.map = map;
    return planeMat.needsUpdate = true;
  });
  ...
  for (j = 0, len = pins.length; j < len; j++) {
    p = pins[j];
  ...
  setTimeout(function() {
    return guiData.wireframe = false;
  }, 4e3);
  ...
  render = function() {
    ...
    p = cloth.particles;
    for (i = k = 0, ref3 = p.length - 1; 0 <= ref3 ? k <= ref3 : k >= ref3; i = 0 <= ref3 ? ++k : --k) {
...
//# sourceMappingURL=cloth_basic.js.map
