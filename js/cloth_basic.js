...
(function() {
  var Cloth, ClothParticle, TIMESTEP, TIMESTEP_SQ, axes, camera, cloth, clothFrameMaterial, clothGeo, clothMaterial, clothObj, gravity, gui, guiData, h, initScene, initStats, j, len, light, onWindowResize, p, pinballObj, pins, planeGeo, planeMat, planeObj, ref, ref1, render, renderer, scene, sphereGeo, sphereMat, stats, textureLoader, wind;
  ...
  render = function() {
    ...
    p = cloth.particles;
    for (i = k = 0, ref2 = p.length - 1; 0 <= ref2 ? k <= ref2 : k >= ref2; i = 0 <= ref2 ? ++k : --k) {
