...
(function() {
  var Ball, DAMPING, DRAG, PBDCloth, PBDVertice, STIFFNESS, TIMESTEP, applyBall2BallContacts, axes, ballMaterial, ballObjs, balls, camera, cloth, clothFrameMaterial, clothGeometry, clothMaterial, clothObj, global, gravity, gui, h, initScene, initStats, light, onWindowResize, pins, ref, render, renderer, scene, stats, switchWireframeOff, wind;
  ...
  PBDCloth = (function() {
    ...
    function PBDCloth(restDist, xSegs, ySegs, material) {
      ...
      this.nagdiff = new THREE.Vector3();
      this.bendConstrains = [];
    ...
    PBDCloth.prototype.simulate = function(deltaTime) {
      var aa, ab, ball, balls, bend, bendCorrection, constrain, d0, d1, d2, d3, doot, e, elen, face, faceA, faceB, gForce, invElen, j, k, l, lambda, len, len1, len2, len3, len4, len5, len6, len7, m, n, n1, n2, normal, o, p0, p1, p2, p3, par0, par1, par2, par3, particle, phi, pin, q, r, ref, ref1, ref2, ref3, ref4, ref5, ref6, ref7, tmp3, tmp4, tmpForce, x, y;
      ...
      for (j = m = 0; m < 1; j = ++m) {
        if (this.collisionProxy != null) {
          ...
          ref6 = this.bendConstrains;
          for (ab = 0, len7 = ref6.length; ab < len7; ab++) {
            bend = ref6[ab];
            faceA = bend[0], faceB = bend[1], par0 = bend[2], par1 = bend[3], par3 = bend[4], par2 = bend[5];
            ref7 = [par0.position, par1.position, par2.position, par3.position], p0 = ref7[0], p1 = ref7[1], p2 = ref7[2], p3 = ref7[3];
            e.subVectors(p3, p2);
            elen = e.length();
            if (elen < 1e-6) {
              continue;
    ...
    PBDCloth.prototype.applyBallContact = function(p, ball) {
      ...
      currentDist = this.diff.lengthSq();
      if (currentDist > ball.radius * ball.radius) {
        return;
      }
    ...
    PBDCloth.prototype.setFaces = function(geoFaces) {
      var faceA, faceB, i, j, k, l, m, n, o, ref, ref1, ref2, ref3, ref4, results;
      this.faces = geoFaces;
      for (j = k = 0, ref = this.hs - 1; 0 <= ref ? k <= ref : k >= ref; j = 0 <= ref ? ++k : --k) {
        for (i = l = 0, ref1 = this.ws - 1; 0 <= ref1 ? l <= ref1 : l >= ref1; i = 0 <= ref1 ? ++l : --l) {
      ...
      for (j = m = 0, ref2 = this.hs - 1; 0 <= ref2 ? m <= ref2 : m >= ref2; j = 0 <= ref2 ? ++m : --m) {
        for (i = n = 0, ref3 = this.ws - 2; 0 <= ref3 ? n <= ref3 : n >= ref3; i = 0 <= ref3 ? ++n : --n) {
      ...
      results = [];
      for (i = o = 0, ref4 = this.ws - 1; 0 <= ref4 ? o <= ref4 : o >= ref4; i = 0 <= ref4 ? ++o : --o) {
        results.push((function() {
          var q, ref5, results1;
          results1 = [];
          for (j = q = 0, ref5 = this.hs - 2; 0 <= ref5 ? q <= ref5 : q >= ref5; j = 0 <= ref5 ? ++q : --q) {
            faceA = this.faces[i * 2 + 1 + j * this.ws * 2];
  ...
  (global.tossBalls = function() {
    var NUM, ballGeometry, ballMass, ballObj, ballRadius, initBallPos, k, ref1, u;
  ...
  render = function() {
    var ball, i, j, k, l, len, len1, m, particle, ref1, ref2, ref3;
    ...
    for (i = l = 0, len1 = balls.length; l < len1; i = ++l) {
      ...
      for (j = m = ref2 = i, ref3 = balls.length; ref2 <= ref3 ? m < ref3 : m > ref3; j = ref2 <= ref3 ? ++m : --m) {
        if (j === i) {
          continue;
        }
...
//# sourceMappingURL=pbd_cloth_ball.js.map
